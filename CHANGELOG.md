...
- Add iterate on array of objects for step of type `axios`

### Updated

- Update dependencies to resolve security advisories (axios, jsonata, velocityjs, ajv, pino and transitive deps)
